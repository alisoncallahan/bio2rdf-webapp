        ...
        throws ServletException, IOException 
    {
        ...
        for(URI nextUniqueQuery : providersByQueryKey.keySet())
        {
            ...
            if(implementedNamespacesForNextQuery.size() > 0 && localSettings.getURICollectionPropertiesFromConfig("autogenerateIncludeStubList").contains(nextUniqueQuery))
            {
                ...
                sb.append(Utilities.xmlEncodeString("<http://purl.org/queryall/query:inputRegex> \""+Utilities.ntriplesEncode(localSettings.getStringPropertyFromConfig("plainNamespaceAndIdentifierRegex"))+"\" ;")+"<br />\n");
